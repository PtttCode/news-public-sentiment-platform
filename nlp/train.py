...
from utils import batch_iter, process_file, build_vocab, read_vocab, read_type_category, read_sentiment_category
from model_stru import TextCNN, TCNNConfig


base_dir = 'data/sentiment_data'
train_dir = os.path.join(base_dir, 'cnews.train_clean.txt')
test_dir = os.path.join(base_dir, 'cnews.test.txt')
val_dir = os.path.join(base_dir, 'cnews.val_clean.txt')
vocab_dir = os.path.join(base_dir, 'cnews.vocab_clean.txt')

save_dir = 'checkpoints/textcnn_20190312'
