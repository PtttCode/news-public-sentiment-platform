...
from utils import read_type_category,  read_vocab
from model_stru import TCNNConfig, TextCNN


base_dir = 'data/news_data'
vocab_dir = os.path.join(base_dir, 'news_vocab.txt')

save_dir = 'checkpoints/textcnn_20190309_news'
...
class TypeModel(object):
    def __init__(self):
        ...
        self.categories, self.cat_to_id = read_type_category()
        self.words, self.word_to_id = read_vocab(vocab_dir)
        self.config.vocab_size = len(self.words)
        self.config.num_classes = 6
